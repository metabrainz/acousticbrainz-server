...
class DatabaseTestCase(TestCase):
    ...
    def drop_tables(self):
        with db.engine.connect() as connection:
            ...
            connection.execute('DROP TABLE IF EXISTS similarity             CASCADE;')
            connection.execute('DROP TABLE IF EXISTS similarity_metrics     CASCADE;')
            connection.execute('DROP TABLE IF EXISTS similarity_stats       CASCADE;')
