...
$(document).ready(function () {
    let apiKey = $("#api-key");
    if (apiKey) {  // Only when key is displayed (user is viewing their own page)
        ...
        $("#btn-generate-api-key").click(function () {
            if (ignoreConfirmation || confirm('Are you sure you want to generate new API key?\n' +
                ...
                $.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        var msg = 'Failed to generate new API key!';
                        if (jqXHR.status == 429) {
