...
def get_similar_recordings(metric, mbid):
    ...
    **NOTE** This parameter will currently default to angular. We need
    to decide with evaluation which distance measure is most appropriate.
...
@bp_path.route("/<metric>", methods=["GET"])
@crossdomain()
