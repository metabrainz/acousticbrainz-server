...
from webserver.views.api.v1.core import _validate_offset
from similarity.index_model import BASE_INDICES
from similarity.metrics import BASE_METRICS
from similarity.exceptions import IndexNotFoundException
...
def _check_index_params():
	...
	if not distance_type:
		...
		if not distance_type in BASE_INDICES[metric]:
	...
	if not n_trees:
		...
		if not n_trees in BASE_INDICES[metric][distance_type]:
